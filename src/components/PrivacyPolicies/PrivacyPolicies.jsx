...
const PoliciesPrivacy = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1a1a2e] flex flex-col items-center justify-center p-4 md:p-6 lg:p-8" style={{ background: 'linear-gradient(180deg, #070727 0%, #090955 70%, #0C0C74 100%)' }}>
