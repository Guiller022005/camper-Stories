                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="col-span-3 space-y-1">
                            <Input
                                ...
                                className={`bg-blue-950/50 border-blue-500/30 text-blue-200 placeholder-blue-400/50 focus:border-yellow-400/50 focus:ring-yellow-400/20 transition-all w-full ${urlError ? 'border-red-500' : ''
                                    }`}
                            />
                            {urlError && (
