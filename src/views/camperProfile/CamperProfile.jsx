...
const NavbarProfile = lazy(() =>
  import("../../components/navbar/NavbarProfile")
);
const ProfileHeader = lazy(() =>
  import("../../components/camperProfile/ProfileHeader")
);
const AboutMe = lazy(() => import("../../components/camperProfile/AboutMe"));
const Dreams = lazy(() => import("../../components/camperProfile/Dreams"));
const TrainingProcess = lazy(() =>
  import("../../components/camperProfile/TrainingProcess")
);
const Proyects = lazy(() => import("@/components/camperProfile/Proyects"));
const SponsorCTA = lazy(() =>
  import("../../components/camperProfile/SponsorCTA")
);
